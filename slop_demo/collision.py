"""Module: collision (refactored v2 — vectorized)."""
import numpy as np
...
def collision_func_1(points, cfg=CollisionConfig()):
...
def collision_func_2(points, cfg=CollisionConfig()):
...
def collision_func_3(points, cfg=CollisionConfig()):
...
def collision_func_4(points, cfg=CollisionConfig()):
